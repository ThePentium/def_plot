...
#
# Created: Fri Jul  3 00:02:06 2015
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8("images/connect.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionImport_PGlayer.setIcon(icon4)
        self.actionImport_PGlayer.setObjectName(_fromUtf8("actionImport_PGlayer"))
        self.actionGetCoordinates = QtGui.QAction(MainWindow)
        self.actionGetCoordinates.setObjectName(_fromUtf8("actionGetCoordinates"))
        ...
        self.toolBar.addAction(self.actionGetCoordinates)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionGetCoordinates.setText(_translate("MainWindow", "GetCoordinates", None))
        self.actionGetCoordinates.setToolTip(_translate("MainWindow", "GetCoordinates", None))
